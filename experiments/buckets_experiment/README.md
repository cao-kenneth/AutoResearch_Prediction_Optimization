...
- `experiments/buckets_experiment/sample_20.csv`
- `experiments/buckets_experiment/outputs/experiment_conditions.csv`
- `experiments/buckets_experiment/outputs/experiment_1.csv`
- `experiments/buckets_experiment/outputs/experiment_2.csv`
- `experiments/buckets_experiment/outputs/experiment_3.csv`
- `experiments/buckets_experiment/outputs/experiment_4.csv`
- `experiments/buckets_experiment/outputs/experiment_5.csv`
- `experiments/buckets_experiment/outputs/runs/<experiment_id>/metrics.json`
- `experiments/buckets_experiment/outputs/brier_scores.csv`
- `experiments/buckets_experiment/outputs/result_matrix.csv`
- `experiments/buckets_experiment/outputs/result_matrix.md`
- `experiments/buckets_experiment/outputs/metric_over_time.png`

Useful options:

```bash
# Create or reuse the 20-row sample without calling Codex.
python experiments/buckets_experiment/run_architecture_experiments.py --sample-only

# Run one experiment.
python experiments/buckets_experiment/run_architecture_experiments.py --experiments exp_03_10_90

# Re-run existing experiment outputs.
python experiments/buckets_experiment/run_architecture_experiments.py --force

# Use deterministic mock responses for code testing only. This does not call Codex.
python experiments/buckets_experiment/run_architecture_experiments.py --mock-codex --force
```
